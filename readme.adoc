image:https://github.com/st-tu-dresden-praktikum/swt21w31/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt21w31/actions"]
...
The pharmacy module is a template project to bootstrap the Java project in the Software Engineering lab.
